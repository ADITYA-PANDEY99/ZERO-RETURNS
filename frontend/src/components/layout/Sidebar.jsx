...
import {
  ...
  Settings, LogOut, ChevronLeft, ChevronRight, Zap, TrendingDown, UserCheck, Layers
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { key: 'enterprise', path: '/enterprise', icon: Layers, label: 'Enterprise Hub' },
...
export default function Sidebar({ collapsed, onToggle }) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav id="sidebar-nav" style={{ flex: 1, padding: '12px 8px', display: 'flex', flexDirection: 'column', gap: 4 }}>
        {!collapsed && (
